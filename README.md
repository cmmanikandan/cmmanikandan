...
- 📬 **Get in Touch:** [manikandanprabhu37@gmail.com](mailto:manikandanprabhu37@gmail.com)

---

### 🎯 Career Objective

> *"To join a reputed organization that offers career growth and job satisfaction, while allowing me to contribute through continuous learning and add value to the organization. I seek opportunities to enhance my skills and knowledge and contribute to organizational success."*

---

### 🎓 Education

| Degree / Program | Institution | Department | Timeline | Performance |
| :--- | :--- | :--- | :--- | :--- |
| **Bachelor of Technology (B.Tech)** | M. Kumarasamy College of Engineering, Karur | Information Technology | 2024 – 2028 <br>*(3rd Year)* | **CGPA: 7.3** <br>*(till 4th semester)* |
...
#### 1. Smart Printing System
- **Overview:** Developed a web-based printing management system for submitting and managing printing requests.
- **Key Highlights:** Designed a responsive interface for efficient order placement and printing requirement management.
- **Technologies:** `HTML` • `CSS` • `JavaScript` • `Java` • `SQL`

#### 2. Expense Tracker
- **Overview:** Developed a web-based application for recording and managing income and expenses.
- **Key Highlights:** Implemented expense categorization and financial record tracking through a simple, user-friendly interface.
...
- 🔹 **CodeChef** – Practice Java *(2026)*
- 🔹 **NPTEL** – Introduction to Internet of Things *(2024)*
- 🔹 **Great Learning** – Machine Learning Fundamentals *(2025)*
- 🔹 **Coursera** – Python for Data Science *(2024)*
- 🔹 **Udemy** – Web Development using HTML, CSS & JavaScript *(2025)*

---

### 🏆 Achievements & Participation

- 📐 **Academic Excellence:** Scored **99/100** in Mathematics at school level.
- 💡 **National-Level Hackathon:** Participated in National-Level Hackathon *(2026)*.
- 🏛️ **State-Level Hackathon:** Participated in State-Level Hackathon at SRM College *(2025)*.
- 🔬 **Technical Workshop:** Attended Machine Learning Workshop at **IIT Madras** *(2024)*.
